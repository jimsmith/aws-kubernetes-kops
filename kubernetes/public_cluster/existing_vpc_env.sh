...
export CLOUD_LABELS="Owner=Jim Smith,Environment=test,Type=k8s,Provisioner=kops"
...
export BASTION="true"                                                           # Provide an external facing point of entry into a network containing private network instances - https://github.com/kubernetes/kops/blob/master/docs/bastion.md
export API_LB_TYPE="public"                                                     # API Load Balancer Ingress - https://github.com/kubernetes/kops/blob/master/docs/cluster_spec.md
...
export UTILITY_SUBNET_IDS="${SUBNET_PUBLIC_1},${SUBNET_PUBLIC_2},${SUBNET_PUBLIC_3}"    # Public Subnet IDs

export ADMIN_ACCESS="${NETWORK_CIDR},<my-ip-here>/32"                           # https://github.com/kubernetes/kops/blob/master/docs/arguments.md#admin-access
